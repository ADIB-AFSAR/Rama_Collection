...
function ProductListingPage() {
  ...
  return (<><a onClick={() => window.history.back()}>
        <i
          style={{ cursor: 'pointer' , left : "5%"}}
          className="bi bi-arrow-left fs-3 text-dark position-absolute "
        ></i>
      </a>
  <img className="d-block w-100" src={isDesktop ? "//naachiyars.in/cdn/shop/files/Site-offer-shipping.png?v=1728371856" : "https://naachiyars.in/cdn/shop/files/Site-offer-shipping-mobile.png?v=1728371856"} alt={`Banner Image`} />
      ...
      <div className="row justify-content-center">
        {filteredProducts?.length > 0 &&
          filteredProducts.map((product, index) => (
            <div
              key={index}
              className="col-lg-3 col-md-4 col-6 mb-4 product-card h-100"
            >
              <img
                onClick={() => {
